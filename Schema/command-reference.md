...
- Use `synthesis_report.py` to generate a review brief from new or changed journal entries and inbox clips without automatically writing canonical knowledge pages.
